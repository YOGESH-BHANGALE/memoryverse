...
(async () => {
  ...
  const fileToUpload = path.resolve(__dirname, '../../backend/AWS_Certified_Solutions_Architect.txt');
  ...
  const artifactPath = path.resolve(__dirname, '../../backend/screenshot_extraction_8b_model.png');
